class WaterPurifier{
	...
	static int minSpeed;
	   ...
	   static boolean onOrOff(){
		   if(isTurnedOn == false ){
			  isTurnedOn = true ;
			  System.out.println("The water purifier is turned on..");
		   }else if(isTurnedOn == true){
			   isTurnedOn = false;
			   System.out.println("The water purifier is turned off..");
		   }
	   ...
	   static void increaseSpeed(){
		   ...
		   if(isTurnedOn==true){
			  ...
			  System.out.println("Please first Turn on the water Purifier");
			}
	   }
